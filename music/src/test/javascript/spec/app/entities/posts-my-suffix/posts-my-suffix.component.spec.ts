...
import { PostsMySuffixComponent } from 'app/entities/posts-my-suffix/posts-my-suffix.component';
...
describe('Component Tests', () => {
  describe('PostsMySuffix Management Component', () => {
    let comp: PostsMySuffixComponent;
    let fixture: ComponentFixture<PostsMySuffixComponent>;
    let service: PostsMySuffixService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [MusicTestModule],
        declarations: [PostsMySuffixComponent],
        providers: [
          {
        ...
        .overrideTemplate(PostsMySuffixComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(PostsMySuffixComponent);
