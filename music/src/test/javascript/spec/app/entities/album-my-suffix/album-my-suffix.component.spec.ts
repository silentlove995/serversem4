...
import { AlbumMySuffixComponent } from 'app/entities/album-my-suffix/album-my-suffix.component';
...
describe('Component Tests', () => {
  describe('AlbumMySuffix Management Component', () => {
    let comp: AlbumMySuffixComponent;
    let fixture: ComponentFixture<AlbumMySuffixComponent>;
    let service: AlbumMySuffixService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [MusicTestModule],
        declarations: [AlbumMySuffixComponent],
        providers: [
          {
        ...
        .overrideTemplate(AlbumMySuffixComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(AlbumMySuffixComponent);
